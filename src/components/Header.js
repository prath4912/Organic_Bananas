  ...
  return (
    <div>
      ...
      <div className="fixed top-0  w-screen z-20  ">
        {/* <div className=" bg-lime-300 text-right text-xs pt-0.5 pe-2 text-black bg-green-600">
          <a
            className=" me-2"
        ...
        <div className=" bg-green- lg:borde lg:border-">
          <nav className="relative top-0.0 lg:top-0  lg:mx-0   overflow-visible lg:boder lg:border-    bg-green-900  ">
              ...
              <Link to="/home">
                <div className="  flex flex-row justify-between hover:scale-90 transition-all active:scale-90 hover:text-yellow-400">
                  <img
                    ...
                    className=" "
                  />
                  <p className="font-bold text-white  hover:text-yellow-400 my-auto ms-2 lg:ms-3 text-2xl lg:text-3xl overflow-visible">
                    Organic Bananas
                  </p>
                </div>
              </Link>
                      ...
                      <div className="nav-item text-white">
                        <Link to="/user/account">
                          <li className="flex">
                            ...
                            {a.profileData &&
                              a.profileData.firstName.slice(0, 8)}
                            ...
                          </li>
                        </Link>
                      </div>
