  ...
  <div className="m-0 hn1 container-fluid">
    ...
    <ul className="dh7 d-flex flex-row justify-content-around">
        ...
        <li className={`nav-item ${location.pathname==="/cart" ? "c1":""}`}> 
          <Link className="nav-link" to="/cart">Cart <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="pb-1 bi bi-cart3" viewBox="0 0 16 16">
