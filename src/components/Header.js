...
export default function Header(props) {
  ...
  return (
    <div>
      ...
      <div className=" bg-lime-300 text-right text-xs pt-0.5 pe-2 text-black"  ><a className="text-blue-700 me-2" href="mailto: organicbananas@gmail.com">organicbananas@gmail.com</a>9096230379 | 8007437075 </div>

      <div className=" bg-green-100 border-b-2 border-black" >

        <nav className="relative top-6 mx-10   overflow-visible border-2 border-black    bg-green-900 ">
            ...
            <Link to="/home">
              <div className="  flex flex-row justify-between hover:scale-90 transition-all active:scale-90 hover:text-yellow-400">
                  <img
                    ...
                    className=" "
                  />
                    <p className="font-bold text-white  hover:text-yellow-400 my-auto ms-3 text-3xl overflow-visible">Organic Bananas </p>
              </div>
            </Link>
                      ...
                      <li
                        ...
                        {!localStorage.getItem("token") ? (
                          ...
                          <div  className="flex flex-col gap-3">
                            <Link onClick={tog} className=" " to="/user">
                              Profile
